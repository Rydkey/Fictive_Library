...
CONSTRAINT fkOeuvreAuteur FOREIGN KEY (idAuteur) REFERENCES AUTEUR(idAuteur)
)ENGINE=InnoDB;
...
prix INT(6),
noOeuvre INT,
CONSTRAINT fkExemplaireOeuvre FOREIGN KEY (noOeuvre) REFERENCES OEUVRE(noOeuvre),
...
CONSTRAINT fkAdherentEmprunt FOREIGN KEY (idAdherent) REFERENCES ADHERENT(idAdherent),
CONSTRAINT fkExemplaireEmprunt FOREIGN KEY (noExemplaire) REFERENCES EXEMPLAIRE(noExemplaire)
)ENGINE=InnoDB DEFAULT CHARSET=	utf8;
...
SELECT a.idAdherent, a.nomAdherent, a.adresse, a.datePaiement FROM ADHERENT as a ORDER BY a.idAdherent;
SELECT e.noExemplaire, e.etat, e.dateAchat, e.prix, e.noOeuvre FROM EXEMPLAIRE as e ORDER BY e.noExemplaire;
SELECT au.idAuteur, au.nomAuteur, au.prenomAuteur, FROM AUTEUR as au ORDER BY au.idAuteur;
SELECT em.idAdherent, em.noExemplaire, em.dateEmprunt, em.dateRendu FROM EMPRUNT as em ORDER BY em.idAdherent;
SELECT o.noOeuvre, o.titre, o.dateParution, o.idAuteur FROM OEUVRE as o ORDER BY o.noOeuvre;

SELECT a.nomAdherent,o.titre,au.nomAuteur,e.etat,em.dateEmprunt FROM ADHERENT as a, EXEMPLAIRE as e, AUTEUR as au, OEUVRE as o, EMPRUNT as em
WHERE em.idAdherent=a.idAdherent AND em.dateRendu IS NULL
ORDER BY em.dateEmprunt;