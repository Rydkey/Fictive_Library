...
<?php
$ma_requete_SQL_Auteur = "SELECT * FROM ADHERENT ORDER BY idAdherent";
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row margin-bottom-60 center-block">
                ...
                <div class="col-lg-2">
                    <button class="btn-link bg-warning"><h1><a href="gestion_test_adherent.php">Adhérents</a></h1></button>
                </div>
                <div class="col-lg-3">
                    ...
                    <?php foreach ($donnees as $value): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="suppr.php?id=<?= $value['idAdherent']?>&Table=ADHERENT"><button type="submit" class="btn-danger btn-xs btn btn-primary btn-embossed btn-wide"><span class="glyphicon glyphicon-minus"></span> Supprimer</button></a>
                            </td>
                        </tr>
                    <?php endforeach?>
                    </tbody>
