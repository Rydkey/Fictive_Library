...
?>
<?php
$ma_requete_SQL_Auteur = "SELECT * FROM EXEMPLAIRE; ";
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="row margin-bottom-60 center-block">
                ...
                <div class="col-lg-3">
                    <button class="btn-link bg-warning"><h1><a href="gestion_test_exemplaire.php">Exemplaire</a></h1></button>
                </div>
            </div>
            <hr>
                    ...
                    <?php foreach ($donnees as $value): ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="suppr.php?id=<?= $value['noExemplaire']?>&Table=EXEMPLAIRE"><button type="submit" class="btn-danger btn-xs btn btn-primary btn-embossed btn-wide"><span class="glyphicon glyphicon-minus"></span> Supprimer</button></a>
                            </td>
                        </tr>
                    <?php endforeach?>
                    </tbody>
